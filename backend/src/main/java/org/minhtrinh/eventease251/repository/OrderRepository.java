...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByParticipant_UserIdOrderByCreatedAtDesc(Long userId);
    
    // Find orders by status for a user
    List<Order> findByParticipant_UserIdAndOrderStatusOrderByCreatedAtDesc(Long userId, String orderStatus);
    ...
    @Query("SELECT DISTINCT o FROM Order o " +
           ...
           "WHERE o.participant.userId = :userId " +
